...
mongoose.connect('mongodb://gk:gkindness@ds151127.mlab.com:51127/generate-kindness' || process.env.MONGODB_URI || process.env.MONGOLAB_URI);
...
app.get('/mission/:id', missionController.getMission);
